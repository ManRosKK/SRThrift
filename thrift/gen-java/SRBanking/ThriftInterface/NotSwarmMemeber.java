...
public class NotSwarmMemeber extends TException implements org.apache.thrift.TBase<NotSwarmMemeber, NotSwarmMemeber._Fields>, java.io.Serializable, Cloneable, Comparable<NotSwarmMemeber> {
  ...
  static {
    schemes.put(StandardScheme.class, new NotSwarmMemeberStandardSchemeFactory());
  ...
  public NotSwarmMemeber deepCopy() {
    return new NotSwarmMemeber(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof NotSwarmMemeber)
      return this.equals((NotSwarmMemeber)that);
    return false;
  }

  public boolean equals(NotSwarmMemeber that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(NotSwarmMemeber other) {
  ...
  private static class NotSwarmMemeberStandardSchemeFactory implements SchemeFactory {
    public NotSwarmMemeberStandardScheme getScheme() {
      return new NotSwarmMemeberStandardScheme();
    }
  }

  private static class NotSwarmMemeberStandardScheme extends StandardScheme<NotSwarmMemeber> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NotSwarmMemeber struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NotSwarmMemeber struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class NotSwarmMemeberTupleSchemeFactory implements SchemeFactory {
    public NotSwarmMemeberTupleScheme getScheme() {
      return new NotSwarmMemeberTupleScheme();
    }
  }

  private static class NotSwarmMemeberTupleScheme extends TupleScheme<NotSwarmMemeber> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NotSwarmMemeber struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NotSwarmMemeber struct) throws org.apache.thrift.TException {
